                    ...
                    <div class="header-pc">
                        ...
                        <div class="header">         
                                    ...
                                    <ul class="mainlist">
                                        ...
                                        <li>  <div class="dropdown open show">

                                                     <div class="dropdown " data-toggle="dropdown" aria-expanded="true"><i class="fas fa-user fa-2x"></i>
                                                     </div>
                                                       <ul class="dropdown-menu" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-4px, 18px, 0px);width: 200px;">
                                                             <li style="
    margin-bottom: 0px;
    margin-top: 0px;
">
                                                                ...
                                                                <a href="Account-Setting/profile.php">
                                                                   &nbsp PROFILE
                                                                </a>
                                                             </li>
                                                             <li style="
...
">
                                                                   ...
                                                                   <a href="../logout.php">   &nbsp SIGN-OUT
                                                                 </a>
                                                             </li>
                                                       </ul>
                                               </div></li>
                                    ...
                                    <nav class="categories">
                                              <ul>
                                                    ...
                                                    <li><a href="Politics.php" class="1show">Politics</a></li>
                                                    <li><a href="Others.php"class="1show">Others</a></li>
                                                    </ul>
                                                </nav>
...
<!-- profile drop down -->                    
                      <div class="dropdown open">
                        ...
                        <div class="dropdown" data-toggle="dropdown" style="width: 30px!important;"><i class="fas fa-user fa-2x " style="color:#1E90FF;"></i></div>
                        <ul class="dropdown-menu" style="width: 30px!important;">
                            <li>
                               
                                  &nbsp  &nbsp <i class="fas fa-user"></i>
                                   <a href="Account-Setting/profile.php"> &nbsp PROFILE
                                </a>
                            </li>
                            ...
                            <li>
                                      ...
                                      &nbsp  &nbsp <i class="fas fa-sign-out-alt"></i>
                                   <a href="logout.php"> &nbsp SIGN-OUT
                                </a>
                            </li>
                        </ul>
                          ...
                          <div id="mySidenav" class="sidenav">
                                      ...
                                      <a  id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="#">Categories</a>     
                                          <div class="dropdown-menu" aria-labelledby="dropdown01" style="width:200px;" >
                                                     ...
                                                     <a class="dropdown-item" href="Politics.php">Politics</a>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                  ...
                                                  <div class="justify-content-center">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="POST" action="connect.php">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <br>
                                                                <input type="text" name="b" class="form-control " placeholder="Password">
                                                            </div>
                                                    ...
                                                    <div class="modal-footer  justify-content-center">
                                                        <div style="text-align: center;"><h5>Need an account?&nbsp&nbsp<a href="signup.html" style="color: blue">Sign up</a></h5></div>
                                                    </div>
